...
GLvoid drawScene() //--- 콜백 함수: 그리기 콜백 함수 
{
    ...
    cameraPos = glm::vec3(0.0f, 0.5f, 0.0f); //--- 카메라 위치
    cameraDirection = glm::vec3(0.0f, 0.0f, 0.0f); //--- 카메라 바라보는 방향
    cameraUp = glm::vec3(0.0f, 0.0, -1.0f); //--- 카메라 위쪽 방향
    Vw = glm::mat4(1.0f);
    ...
    Pj = glm::mat4(1.0f);
    Pj = glm::ortho(-1.0f, 1.0f, -1.0f, 1.0f, -1.0f, 1.0f);
    ...
    cameraPos = glm::vec3(0.0f, 0.0f, 0.1f); //--- 카메라 위치
    cameraDirection = glm::vec3(0.0f, 0.0f, 0.0f); //--- 카메라 바라보는 방향
